    ...
    if($_SERVER['REQUEST_METHOD'] !== 'POST' || !isset($_POST['client_fetch_token_request']) || $_POST['client_fetch_token_request'] !== $token) {
        ...
        if ($stmt->execute()) {
                            ...
                            $mail->Body = '
                                <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
                                    <div style="text-align: center;">
                                        ...
                                        <h2 style="color: #28a745;">Welcome to Ms. Clean Laundry Ease!</h2>
                                    </div>
                                    ...
                                    <hr>
                                    <p style="font-size: 12px; color: #777;">&copy; ' . date("Y") . ' Ms. Clean Laundry Ease. All rights reserved.</p>
                                </div>
                            ';
            ...
            if ($user = $result->fetch_assoc()) {
                ...
                if ($stmt->execute() && $stmt->affected_rows > 0) {
                    ...
                    try {
                        ...
                        $mail->isHTML(true);
                        $mail->Subject = 'Account Request Rejected - Ms. Clean Laundry Ease';
                        $mail->Body    = '
                            <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
                            <div style="text-align: center;">
                            ...
                            <p>Thank you for your interest in joining <b>Ms. Clean Laundry Ease</b>. 
                            ...
                            <p style="font-size: 12px; color: #777;">
                                &copy; ' . date("Y") . ' Ms. Clean Laundry Ease. All rights reserved.
                            </p>
                            </div>
                        ';
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Account Removed - Ms. Clean Laundry Ease';
                $mail->Body    = '
