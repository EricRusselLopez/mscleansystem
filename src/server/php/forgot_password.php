...
switch ($action) {
    case 'request':
        ...
        if ($stmt->num_rows === 0) {
            echo json_encode(["response" => false, "error" => "Email not found"]);
            exit;
        }
        $stmt->close();
        ...
        try {
            ...
            $mail->setFrom('mrscleanlaundry15@gmail.com', 'Ms. Clean Laundry Ease');
            ...
            $mail->Body    = "
                <div style='font-family:Arial,sans-serif;padding:20px;background:#f9f9f9;border-radius:8px;'>
                  ...
                  <hr>
                  <p style='font-size:12px;color:#999;'>&copy; " . date('Y') . " Ms. Clean Laundry Ease</p>
                </div>
            ";
            $mail->send();
