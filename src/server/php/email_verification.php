    ...
    try {
        ...
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
            <div style="text-align: center;">
                <img src="https://i.imgur.com/xmdt55d.png" alt="Ms. Clean Laundry Ease Logo" style="max-width: 120px; margin-bottom: 20px;">
            ...
            <p style="margin-top: 30px; font-size: 12px; color: #999;">&copy; ' . date("Y") . ' Ms. Clean Laundry Ease. All rights reserved.</p>
        </div>
    ';
        $mail->send();
