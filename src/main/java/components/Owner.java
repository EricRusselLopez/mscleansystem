...
public class Owner extends JPanel implements CustomBorder {
    ...
    private void initComponents() {                          
        ...
        DefaultTableModel modelReportsDashboard = new DefaultTableModel(
            new Object[][] {},
            new String[] {
                "T.I", "Date & Time", "Customer", "Service Type", "₱ Total Amount", "Branch", "Status"
            }
        ) {
            ...
            public String getToolTipText(MouseEvent e) {
                ...
                if (row >= 0) {
                    return "<html><div style='padding: 5px; font-size: 11px'>"
                            ...
                            + "<br><strong>Service Type:</strong> " + getValueAt(row, 3)
                            + "<br><strong>Total Amount:</strong> " + getValueAt(row, 4)
                            + "<br><strong>Branch:</strong> " + getValueAt(row, 5)
                            + "<br><strong>Status:</strong> " + getValueAt(row, 6)
                            + "</div></html>";
                }
                return null;
            }
        ...
        generateReportsDashboard.loadReportsRequests(modelReportsDashboard);

        new Timer(2000, e -> generateReportsDashboard.loadReportsRequests(modelReportsDashboard)).start();
        ...
        notifications.loadNotificationsRequests(model);

        new Timer(2000, e -> notifications.loadNotificationsRequests(model))
            .start();
        ...
        barChart.setBackgroundPaint(new Color(156, 255, 253));
        ...
        jPanel8.add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 60, -1, 30));
        ...
        DefaultTableModel modelReports = new DefaultTableModel(
            new Object[][] {},
            new String[] {
                "Transaction ID", "Date & Time", "Customer", "Service Type", "₱ Total Amount", "Branch", "Status"
            }
        ) {
            boolean[] canEdit = new boolean[] {
                false, false, false, false, false, false, false
        ...
        jTable5 = new JTable(modelReports) {
            ...
            public String getToolTipText(MouseEvent e) {
                ...
                int row = rowAtPoint(point);
                if (row >= 0) {
                    return "<html><div style='padding: 6px;'>"
                            + "<strong>Transaction ID:</strong> " + getValueAt(row, 0)
                            + "<br><strong>Date & Time:</strong> " + getValueAt(row, 1)
                            + "<br><strong>Customer:</strong> " + getValueAt(row, 2)
                            + "<br><strong>Service Type:</strong> " + getValueAt(row, 3)
        ...
        new Timer(2000, e -> generateReports.loadReportsRequests(modelReports)).start();
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Status", "Pending", "Canceled", "Pickup", "Delivered", "Paid" }));
        jPanel9.add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(775, 60, -1, 35));
        ...
        accountApprovalBtn.addActionListener(e -> authenticator.approveUser(jTable1, (DefaultTableModel) jTable1.getModel()));
        rejectBtn.addActionListener(e -> authenticator.rejectUser(jTable1, (DefaultTableModel) jTable1.getModel()));
        removeBtn.addActionListener(e -> authenticator.removeUser(jTable1, (DefaultTableModel) jTable1.getModel()));
        ...
        jComboBox5.setModel(new DefaultComboBoxModel<>(comboItems));
        jComboBox4.setModel(new DefaultComboBoxModel<>(comboItems));
        jComboBox2.setModel(new DefaultComboBoxModel<>(comboItems));
    }
        ...
        jPanel10.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 60, -1, 30));
    ...
    private void applyReportsFilter(TableRowSorter<DefaultTableModel> sorter, String statusFilter, String idFilter, String branchFilter) {
        ...
        if (hasBranch) {
            filters.add(RowFilter.regexFilter("(?i)" + Pattern.quote(branchFilter), 5));
        }

        if (!hasStatus && !hasID && !hasBranch) {
            sorter.setRowFilter(null);
        } else {
